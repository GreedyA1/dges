...
import * as ProjectsFeature from './projects.reducers';
...
export class ProjectsFacade {
  ...
  allProjects$ = this.store.pipe(select(ProjectsSelectors.getProjectsData));
  ...
  editOrAddSuccess(): Observable<Actions> {
    return this.actions$.pipe(
      ofType(ProjectsActions.addProjectSuccess, ProjectsActions.editProjectSuccess)
    );
  }
}
